...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CertProject.Models.CandidateExam", b =>
                {
            ...
            modelBuilder.Entity("CertProject.Models.Exam", b =>
                {
                    b.Property<Guid>("ExamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CertProject.Models.Questions", b =>
                {
            ...
            modelBuilder.Entity("CertProject.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Candidate", b =>
                {
                    b.HasBaseType("CertProject.Models.User");
            ...
            modelBuilder.Entity("CertProject.Models.Admin", b =>
                {
                    b.HasBaseType("CertProject.Models.User");
            ...
            modelBuilder.Entity("CertProject.Models.Marker", b =>
                {
                    b.HasBaseType("CertProject.Models.User");
            ...
            modelBuilder.Entity("CertProject.Models.QualityControl", b =>
                {
                    b.HasBaseType("CertProject.Models.User");
            ...
            modelBuilder.Entity("CertProject.Models.CandidateExam", b =>
                {
                    ...
                    b.HasOne("CertProject.Models.Exam", "Exam")
                        .WithMany()
            ...
            modelBuilder.Entity("Candidate", b =>
                {
                    b.HasOne("CertProject.Models.User", null)
                        .WithOne()
            ...
            modelBuilder.Entity("CertProject.Models.Admin", b =>
                {
                    b.HasOne("CertProject.Models.User", null)
                        .WithOne()
                        .HasForeignKey("CertProject.Models.Admin", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CertProject.Models.Marker", b =>
                {
                    b.HasOne("CertProject.Models.User", null)
                        .WithOne()
                        .HasForeignKey("CertProject.Models.Marker", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CertProject.Models.QualityControl", b =>
                {
                    b.HasOne("CertProject.Models.User", null)
                        .WithOne()
                        .HasForeignKey("CertProject.Models.QualityControl", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
